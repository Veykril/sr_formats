...
pub(crate) mod combinator {
    ...
    #[inline]
    pub fn fixed_string_64<'a, E: ParseError<&'a [u8]>>(
        i: &'a [u8],
    ) -> IResult<&'a [u8], String, E> {
        fixed_string(64)(i)
    }
    ...
    #[inline]
    pub fn fixed_string_128<'a, E: ParseError<&'a [u8]>>(
        i: &'a [u8],
    ) -> IResult<&'a [u8], String, E> {
        fixed_string(128)(i)
    }
    ...
    #[inline]
    pub fn fixed_string_256<'a, E: ParseError<&'a [u8]>>(
        i: &'a [u8],
    ) -> IResult<&'a [u8], String, E> {
        fixed_string(256)(i)
    }
    ...
    /// Reads a Vector3<f32>
    #[inline]
    pub fn vector4_f32<'a, E: ParseError<&'a [u8]>>(
        i: &'a [u8],
    ) -> IResult<&'a [u8], Vector4<f32>, E> {
    ...
    /// Reads a Vector3<f32>
    #[inline]
    pub fn vector3_f32<'a, E: ParseError<&'a [u8]>>(
        i: &'a [u8],
    ) -> IResult<&'a [u8], Vector3<f32>, E> {
