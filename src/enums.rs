...
impl TryFrom<u32> for ResourceAnimationType {
    ...
    fn try_from(val: u32) -> Result<Self, Self::Error> {
        Ok(match val {
            ...
            0xC7 => ResourceAnimationType::UnkC7,
            0xC8 => ResourceAnimationType::UnkC8,
            0xC9 => ResourceAnimationType::UnkC9,
            0xCA => ResourceAnimationType::UnkCA,
            0xCB => ResourceAnimationType::UnkCB,
            0xCC => ResourceAnimationType::UnkCC,
            0xCD => ResourceAnimationType::UnkCD,
            0xCE => ResourceAnimationType::UnkCE,
            0xCF => ResourceAnimationType::UnkCF,
            0xD0 => ResourceAnimationType::UnkD0,
            0xD1 => ResourceAnimationType::UnkD1,
            0xD2 => ResourceAnimationType::UnkD2,
            0xD3 => ResourceAnimationType::UnkD3,
            0xD4 => ResourceAnimationType::UnkD4,
            0xD5 => ResourceAnimationType::UnkD5,
            0xD6 => ResourceAnimationType::UnkD6,
            0xD7 => ResourceAnimationType::UnkD7,
            0xD8 => ResourceAnimationType::UnkD8,
            0xD9 => ResourceAnimationType::UnkD9,
            0xDC => ResourceAnimationType::UnkDC,
